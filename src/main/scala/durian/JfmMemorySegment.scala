...
object JfmMemorySegment extends MemorySegment[java.lang.foreign.MemorySegment] {
  extension (memorySegment: java.lang.foreign.MemorySegment) {
    override def rootAddress = Address.unsafe(memorySegment.address())
    ...
    override def getUtf8String(addr: Address): String = memorySegment.getString(addr.value)
    ...
    override def setUtf8String(addr: Address, v: String): Unit = memorySegment.setString(addr.value, v)
